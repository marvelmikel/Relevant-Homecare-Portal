...
<x-guest-layout>
        ...
        <div class="account-content">
            ...
            <a href="index.html"><img src="{{ URL::asset('assets/img/logo.png')}}" alt="Admin Dashboard"></a>
            </div>
            ...
            <div class="account-footer">
                @if (Route::has('password.request'))
            <p>Reset Password <a href="{{ route('password.request') }}">Login</a>{{ __('Forgot your password?') }}</p>
            @endif
            </div>
            </form>
